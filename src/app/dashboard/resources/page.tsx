    ...
    return (
        <div className="flex flex-col gap-6 fade-in">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card className="border-l-4 border-l-blue-500 hover:shadow-lg transition-shadow duration-200">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Available documents</p>
                    </CardContent>
                </Card>

                <Card className="border-l-4 border-l-purple-500 hover:shadow-lg transition-shadow duration-200">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">SOPs & Policies</CardTitle>
            ...
            <div>
                ...
                <DocumentList documents={documents} emptyMessage="No resources found." />
            </div>
        </div>
    )
}
