...
import { MessageSquare, Mail, ExternalLink, Copy } from "lucide-react"
...
type EmployeeTeamMemberCardProps = {
    member: TeamMember
}

export function EmployeeTeamMemberCard({ member }: EmployeeTeamMemberCardProps) {
    ...
    return (
        <Card className="hover:shadow-lg transition-all duration-200 border-gray-200 dark:border-gray-800 overflow-hidden group">
            <CardContent className="p-0 flex h-full">
                ...
                {/* Right Section: Info */}
                <div className="flex-1 p-2.5 flex flex-col justify-center gap-0.5 min-w-0">
                    {/* Line 1: Name */}
